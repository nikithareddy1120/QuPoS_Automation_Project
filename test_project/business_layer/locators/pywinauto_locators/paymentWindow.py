paymentWindow = {
    ...
    "Pay per Item": {"auto_id": "CashPayment_PayPerItem_Button_Cash"},
    "dueAmountCash" : {"auto_id": "CashPayment_SetAmount_Button_Cash"},
    "Apply Payment for Cash Payment" : {"auto_id" : "CashPayment_ApplyPayment_Button_Cash"},
    "tenderedAmount" : {"auto_id": "CheckView_TenderedString"},
    "dueAmountInCart" : {"auto_id": "CheckView_DueString"},
    "totalAmount" : {"auto_id": "TextBlock_CheckTotal"}
}